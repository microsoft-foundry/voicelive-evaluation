...
$configs = @(
    ...
    @{
        RowKey = "agent-cross-resource"
        PartitionKey = "voicelive"
        Name = "agent-cross-resource"
        Description = "Cross-resource agent mode - VoiceAgentwBingWebSearch on jagoerge-voicelive-sec-resource"
        Model = ""
        SampleRate = "24000"
        VoiceName = "en-US-Ava:DragonHDLatestNeural"
        VoiceType = "azure-standard"
        ...
        IsDefault = "false"
        PushToTalk = "false"
        AgentName = "VoiceAgentwBingWebSearch"
        ProjectName = "jagoerge-voicelive-sec"
        AgentVersion = "14"
        ConversationId = ""
        FoundryResourceOverride = "jagoerge-voicelive-sec-resource"
