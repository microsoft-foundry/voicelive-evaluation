...
|--------|-------------|---------------|
| `test_eval_naming.py` | Naming function unit tests | 24 tests — `generate_eval_group_name`, `generate_run_name`, `_short_voice_name`, `_sanitize_eval_name` (no deployment needed, mocks Azure SDK) |
